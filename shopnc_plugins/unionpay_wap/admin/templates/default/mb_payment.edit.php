  ...
  <form id="post_form" method="post" name="form1" action="<?php echo urlAdmin('mb_payment', 'payment_save');?>">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <?php } ?>
        <?php if ($output['payment']['payment_code'] == 'unionpay') { ?>
            <tr>
                <td colspan="2" class="required"><label class="validation">银联商户号：</label> </td>
            </tr>
            <tr class="noborder">
                <td class="vatop rowform"><input name="unionpay_account" id="unionpay_account" value="<?php echo $output['payment']['payment_config']['unionpay_account'];?>" class="txt" type="text"></td>
                <td class="vatop tips"></td>
            </tr>
            <tr>
                <td colspan="2" class="required"><label class="validation">签名证书密码: </label></td>
            </tr>
            <tr class="noborder">
                <td class="vatop rowform"><input name="cert_passwd" id="cert_passwd" value="<?php echo $output['payment']['payment_config']['cert_passwd'];?>" class="txt" type="text"></td>
                <td class="vatop tips"></td>
            </tr>
